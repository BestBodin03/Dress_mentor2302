...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val arrayList = arrayListOf("Not choose","Male", "Female")
        ...
        val day_arrayList = arrayListOf("Not choose","Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
        ...
        val formality_spinner: Spinner = binding.formalitySpinner
        val formality_arrayList = arrayListOf("ทางการ", "กึ่งทางการ", "ไม่เป็นทางการ")
        val formality_adapter = ArrayAdapter(requireContext(), R.layout.simple_spinner_item, formality_arrayList)
        formality_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        formality_spinner.adapter= formality_adapter
